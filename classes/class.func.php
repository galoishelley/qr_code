		...
		if (isset ( $_POST ['action_type'] )){
			...
			if($action_type == "create" || $action_type == "update"){
				...
				if($action_type == "create"){
					$this->func_values['create_user'] = $this->user_name;
					$this->func_values['create_date'] = $this->date;
				}

				$this->func_values['update_user'] = $this->user_name;
				$this->func_values['update_date'] = $this->date;
